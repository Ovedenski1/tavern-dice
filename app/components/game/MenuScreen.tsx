  ...
  return (
    <motion.button
      ...
      className={[
        ...
        "rounded-[1rem] border px-4 py-3 text-center transition sm:rounded-[1.2rem] sm:px-5 sm:py-4 lg:px-5 lg:py-2.5",
        disabled
    ...
    >
      ...
      <div className="absolute left-4 top-1/2 z-10 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-[0.7rem] border border-[#6b4b10] bg-[#fff2c2]/70 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)] sm:left-5 sm:h-10 sm:w-10 sm:rounded-[0.8rem] lg:h-9 lg:w-9">
      ...
      {badge ? (
        <span className="absolute right-3 top-1/2 z-10 -translate-y-1/2 rounded-full border border-black/10 bg-black/10 px-2 py-1 text-[0.58rem] uppercase tracking-[0.1em] text-[#4c3202] sm:right-5 sm:text-[0.62rem] sm:tracking-[0.12em] lg:px-1.5 lg:py-0.5">
          {badge}
        </span>
      ) : null}
    </motion.button>
  ...
  return (
    <>
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        exit={{ opacity: 0, y: -18 }}
        className="relative h-[100dvh] overflow-hidden bg-[#4298CB] px-4 py-3 sm:min-h-[100dvh] sm:p-6 lg:px-6 lg:py-4"
      >
        <StarField />
        <MenuFooter version="1.4" />

        <div className="relative z-10 mx-auto flex h-full w-full max-w-3xl items-start justify-center lg:max-w-4xl">
          <div className="flex h-full w-full flex-col items-center justify-center lg:justify-center lg:pt-1 lg:pb-10">
            <motion.h2
              initial={{ opacity: 0, y: 12 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.05 }}
              className="text-center text-[2.35rem] font-bold leading-none sm:text-5xl md:text-6xl lg:text-[2.9rem]"
              style={{
                fontFamily: "var(--font-heading)",
            ...
            <div className="mt-3 text-center sm:mt-4 lg:mt-1">
            ...
            <motion.div
              ...
              className="mx-auto mt-5 w-full max-w-[560px] rounded-[2rem] p-2 sm:mt-10 sm:p-4 lg:mt-4 lg:max-w-[640px] lg:p-2"
            >
              <div className="space-y-3 sm:space-y-3 lg:space-y-2">
